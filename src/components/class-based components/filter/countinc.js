        ...
        return(
            <div>
               {/* {this.state.products.map((eachItem)=>{
                    return (
                        <div>
                            <h4>title={eachItem.title}</h4>
                            <h4>price={eachItem.price}</h4>
                            <h4>count={eachItem.rating.count}</h4>
                            <br></br>
                        </div>
                    )
                })}   */}
                {
                    this.state.products.map((eachObject)=>{
                        return(
                            <div>
                                <ProductListing data={eachObject} communication={this.Childtoparent} increment={this.increment} decrement={this.decrement} delete={this.delete} />
                                </div>
                        )
                    })
                }
